...
describe('anonymization disposition policy v1.1', () => {
  it('closes relationship/privacy review while keeping diagnostic and artifact gates fail-closed', () => {
    ...
    expect(result.policyVersion).toBe('1.1.0');
